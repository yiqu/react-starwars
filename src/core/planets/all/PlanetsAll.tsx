...
function PlanetsAll() {
  ...
  const planetsGrouped: StarwarsContent[] = useAppSelector(fromplanetsSelectors.planetsGrouped);
  const firstTimeLoading: boolean = useAppSelector(fromplanetsSelectors.firstTimeLoading);
  const apiLoading: boolean = useAppSelector(fromplanetsSelectors.apiLoading);
  const currentFetchParams: HttpParams | undefined = useAppSelector(fromplanetsSelectors.extraParams);
  ...
  return (
    <Stack direction="column" width="100%">
      ...
      <SimpleGridDisplay data={ planetsGrouped } itemUrlPath="planets" />
