...
import { useFetchPlanetsQuery, useFetchStarshipsQuery } from "src/core/store/swapi/swapi";
...
function PlanetsAll() {
  ...
  const { data, isFetching, isLoading, error, isSuccess, isError, refetch } = useFetchPlanetsQuery({ 
    entity: ENTITY_NAME, 
    pagination: { page }
  });
